...
namespace HotelBooking.Migrations
{
    ...
    [Migration("20230731212021_UpdateHotelOwnerName")]
    partial class UpdateHotelOwnerName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.UserModels.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.Models.UserModels.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.Models.UserModels.Reservation", b =>
                {
                    ...
                    b.HasOne("Entities.Models.UserModels.User", "User")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("Entities.Models.UserModels.User", b =>
                {
                    b.HasOne("Entities.Models.UserModels.Role", "Role")
                        .WithMany("Users")
